        ...
        <div class="row d-flex justify-content-center">
          ...
          <div class="col-md-5 col-12">
            ...
            <div data-mdb-input-init class="form-white mb-4">
              <input title="e-mail" type="email" id="form2Example1" class="form-control" />
              <label mdbLabel class="form-label" for="form2Example1" placeholder="Email address">Email address</label>
            </div>
          </div>
          <!--Grid column-->
